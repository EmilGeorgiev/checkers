...
import EmilGeorgievCheckersAliceCheckersCheckers from './EmilGeorgiev/checkers/alice.checkers.checkers'
...
export default { 
  EmilGeorgievCheckersAliceCheckersCheckers: load(EmilGeorgievCheckersAliceCheckersCheckers, 'alice.checkers.checkers'),
